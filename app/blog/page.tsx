                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {posts.map((post, index) => (
                            ...
                            >
                                <Link
                                    href={`/blog/${post.slug}`}
                                    className="aspect-[16/9] overflow-hidden bg-muted block relative"
                                >
                                    {/* 
                    TODO: Handle local images properly. 
                    For now, we might need a placeholder or a way to serve these images.
                    If post.image is a URL, it works. If it's relative, it might fail.
                  */}
                                    {post.image && (
                                        <img
                                            src={post.image}
